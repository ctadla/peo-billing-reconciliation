...
async function seedPEO() {
  ...
  await db.insert(retroAdjustments).values([
    { invoiceId: bhJan.id, worksite: "Denver HQ", memberName: "Tom Harris", eventType: "Cancelled Coverage", originalPeriod: "Dec 2025", effectiveDate: "2025-12-01", amount: "-62.00", reasonCode: "Late plan correction refund", carrier: "Aetna", lineOfCoverage: "Medical", plan: "Aetna Select PPO", tier: "Employee Only", processedAt: new Date("2025-12-02T15:00:00-08:00") },
    { invoiceId: bhJan.id, worksite: "Denver HQ", memberName: "Tom Harris", eventType: "Cancelled Coverage", originalPeriod: "Dec 2025", effectiveDate: "2025-12-01", amount: "-22.50", reasonCode: "Late plan correction refund", carrier: "Guardian", lineOfCoverage: "Dental", plan: "Guardian Dental PPO", tier: "Employee Only", processedAt: new Date("2025-12-02T15:00:00-08:00") },
    { invoiceId: bhJan.id, worksite: "Denver HQ", memberName: "Tom Harris", eventType: "Cancelled Coverage", originalPeriod: "Dec 2025", effectiveDate: "2025-12-01", amount: "-17.00", reasonCode: "Late plan correction refund", carrier: "Guardian", lineOfCoverage: "Vision", plan: "Guardian Vision", tier: "Employee Only", processedAt: new Date("2025-12-02T15:00:00-08:00") },
    { invoiceId: bhJan.id, worksite: "Denver HQ", memberName: "Tom Harris", eventType: "Cancelled Coverage", originalPeriod: "Dec 2025", effectiveDate: "2025-12-01", amount: "-18.50", reasonCode: "Late plan correction refund", carrier: "Guardian", lineOfCoverage: "Life/Disability", plan: "Guardian Life & AD&D", tier: "Employee Only", processedAt: new Date("2025-12-02T15:00:00-08:00") },
  ]);
  ...
  await db.insert(postCutoffChanges).values([
    { invoiceId: cdMar.id, worksite: "Seattle Office", memberName: "Ryan Cho", eventType: "New Coverage", effectiveDate: "2026-03-10", expectedPremium: "590.00", expectedMonth: "April 2026 Invoice", carrier: "Aetna", lineOfCoverage: "Medical", plan: "Premera Blue Cross", tier: "Employee Only", processedAt: new Date("2026-02-07T14:00:00-08:00") },
    { invoiceId: cdMar.id, worksite: "Seattle Office", memberName: "Ryan Cho", eventType: "New Coverage", effectiveDate: "2026-03-10", expectedPremium: "45.00", expectedMonth: "April 2026 Invoice", carrier: "Guardian", lineOfCoverage: "Dental", plan: "Guardian Dental PPO", tier: "Employee Only", processedAt: new Date("2026-02-07T14:00:00-08:00") },
    { invoiceId: cdMar.id, worksite: "Seattle Office", memberName: "Ryan Cho", eventType: "New Coverage", effectiveDate: "2026-03-10", expectedPremium: "12.00", expectedMonth: "April 2026 Invoice", carrier: "Guardian", lineOfCoverage: "Vision", plan: "Guardian Vision", tier: "Employee Only", processedAt: new Date("2026-02-07T14:00:00-08:00") },
    { invoiceId: cdMar.id, worksite: "Seattle Office", memberName: "Ryan Cho", eventType: "New Coverage", effectiveDate: "2026-03-10", expectedPremium: "18.50", expectedMonth: "April 2026 Invoice", carrier: "Guardian", lineOfCoverage: "Life/Disability", plan: "Guardian Life & AD&D", tier: "Employee Only", processedAt: new Date("2026-02-07T14:00:00-08:00") },
  ]);
