...
async function seed() {
  ...
  await db.insert(retroAdjustments).values([
    ...
    { invoiceId: marchInv.id, worksite: "San Francisco HQ", memberName: "Fiona Chen", eventType: "New Coverage", originalPeriod: "Jan 2026", effectiveDate: "2026-01-15", amount: "385.00", reasonCode: "Marriage - tier upgrade retro to Jan", carrier: "Aetna", lineOfCoverage: "Medical", plan: "Kaiser Gold PPO", tier: "Employee + Spouse", processedAt: new Date("2026-02-04T10:00:00-08:00") },
    { invoiceId: marchInv.id, worksite: "San Francisco HQ", memberName: "Fiona Chen", eventType: "New Coverage", originalPeriod: "Jan 2026", effectiveDate: "2026-01-15", amount: "16.50", reasonCode: "Marriage - tier upgrade retro to Jan", carrier: "Guardian", lineOfCoverage: "Dental", plan: "Guardian Dental PPO", tier: "Employee + Spouse", processedAt: new Date("2026-02-04T10:00:00-08:00") },
    { invoiceId: marchInv.id, worksite: "San Francisco HQ", memberName: "Fiona Chen", eventType: "New Coverage", originalPeriod: "Jan 2026", effectiveDate: "2026-01-15", amount: "5.00", reasonCode: "Marriage - tier upgrade retro to Jan", carrier: "Guardian", lineOfCoverage: "Vision", plan: "Guardian Vision", tier: "Employee + Spouse", processedAt: new Date("2026-02-04T10:00:00-08:00") },
